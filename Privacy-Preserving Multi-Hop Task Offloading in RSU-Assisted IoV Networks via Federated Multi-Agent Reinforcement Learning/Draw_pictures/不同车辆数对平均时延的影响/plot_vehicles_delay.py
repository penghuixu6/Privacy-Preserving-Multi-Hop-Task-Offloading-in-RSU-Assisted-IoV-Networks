...
def main():
    ...
    ax.bar(x - width, dqn, width, label='DQN', color='#ffdbd1', edgecolor='black', linewidth=0.8, zorder=3)
    ax.bar(x, ppo, width, label='PPO', color='#d6e2ee', edgecolor='black', linewidth=0.8, zorder=3)
    ax.bar(x + width, fed_mappo, width, label='FMAPPO', color="#0183bb", edgecolor='black', linewidth=0.8, zorder=3)
